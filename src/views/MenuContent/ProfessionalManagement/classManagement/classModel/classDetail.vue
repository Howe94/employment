<template>
  <el-col :span="24" class="main">
    <div>
      班级就业西悉尼
      <span>{{$route.query.classNo}}</span>
    </div>
    <div>
      <!-- 数据可视化学习——饼图 -->
      <div style="width: 40%;height: 400px;border:1px solid rgb(180,180,180)" id="echartss"></div>
    </div>
  </el-col>
</template>
<script>
  ...
  data() {
    return {
      echarts1_option: {
        ...
        backgroundColor: "rgba(177, 216, 250, 0.76)",
        //标题
        title: {
          text: "流量来源",
          subtext: "饼图示例",
